		...
		AdapterView.OnItemClickListener
{
	...
	private static final Integer[] THUMB_IDS = { R.drawable.bg_1, R.drawable.bg_2, R.drawable.bg_3,
			R.drawable.bg_4, R.drawable.bg_5, R.drawable.bg_6 };

	private static final Integer[] IMAGE_IDS = { R.drawable.bg_1, R.drawable.bg_2, R.drawable.bg_3,
			R.drawable.bg_4, R.drawable.bg_5, R.drawable.bg_6 };
